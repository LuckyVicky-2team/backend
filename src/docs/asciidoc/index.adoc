...
include::{snippets}/get-review-meeting-reviews/http-request.adoc[]
include::{snippets}/get-review-meeting-reviews/path-parameters.adoc[]

==== *응답*

include::{snippets}/get-review-meeting-reviews/http-response.adoc[]
include::{snippets}/get-review-meeting-reviews/response-fields.adoc[]
