...
include::{snippets}/check-password-equal/http-request.adoc[]
- http-request
include::{snippets}/check-password-equal/request-parts.adoc[]

==== *응답*

include::{snippets}/check-password-equal/http-response.adoc[]
...
- http-request
include::{snippets}/delete-user/request-parts.adoc[]
